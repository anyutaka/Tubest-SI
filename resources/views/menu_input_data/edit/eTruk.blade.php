                    ...
                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                        <div class="mdc-card">
                            <div class="mdc-card__primary">
                                <form action="/updateTruk/{{ $data->id }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Id_Truk</label>
                                        <br>
                                        <input type="string" name="id_truk" class="form-control"
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Pilih Truk</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <br>
                                        <input type="string" name="kapasitas" class="form-control"
                                            id="exampleInputEmail1" aria-describedby="emailHelp"
