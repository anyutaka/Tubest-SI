                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card">
                        <div class="mdc-card__primary">
                            <form action="/instJadwal" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Id Jadwal</label>
                                    <input type="string" name="id_jadwal" class="form-control" id="exampleInputEmail1"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="id_supir">
                                            <option selected disabled>-- Pilih Nama Supir --</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="id_rute">
                                            ...
                                            @foreach ($rute as $row)
                                                <option value="{{ $row->id }}">
                                                    {{ $row->id_rute }}-{{ $row->nama_rute }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
