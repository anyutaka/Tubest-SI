                ...
                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                    <div class="mdc-card">
                        <div class="mdc-card__primary">
                            <form action="/instPengiriman" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="id_jadwal">
                                            ...
                                            @foreach ($jadwal as $row)
                                                <option value="{{ $row->id }}">{{ $row->id_jadwal }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <br>
                                    <input type="date" name="estimasi" class="form-control" id="exampleInputEmail1"
